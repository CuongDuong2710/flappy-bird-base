      ...
      <header className="relative overflow-hidden bg-gradient-to-r from-blue-500 to-sky-600 shadow-lg">
        ...
        <div className="relative container mx-auto px-4 py-8 md:py-16 text-center">
          ...
          <p className="text-xl text-sky-50 mb-8 max-w-2xl mx-auto">
            The classic Flappy Bird game on Base Network! 
            Tap to flap, avoid pipes, and mint exclusive NFTs based on your score.
          </p>
      ...
      <section id="game" className="py-20 px-4">
        <div className="container mx-auto">
          ...
          <p className="text-xl text-gray-700 text-center mb-12 max-w-3xl mx-auto">
            Tap or press Space to flap! Navigate through pipes and earn points. 
            Reach milestone scores to unlock NFT minting!
          </p>
          <FlappyBirdGame />
        </div>
      </section>
